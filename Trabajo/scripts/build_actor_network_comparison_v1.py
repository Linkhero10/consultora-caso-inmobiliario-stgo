...
- La clasificacion institucional sigue siendo parcial (312/1222 nodos sin
  ...
  enrichment_actor_v3_2 mete a 'Estado' en el mismo saco que actores no
...
# enrichment_evento_v3_2 NO contiene nombres de actor: su columna 'nombre'
...
ACTOR_SOURCE_TABLES = ("enrichment_actor_v3_2", "enrichment_institucion_v3_2", "actor_second_pass_v2")
    ...
    rows = conn.execute(
        ...
        SELECT l.document_id, l.nombre, p.case_id, l.source_table,
               CASE
                   ...
                   WHEN l.source_table = 'enrichment_actor_v3_2' AND ea.tipo IN ({",".join("?" for _ in INSTITUTIONAL_ACTOR_TIPOS)}) THEN 1
